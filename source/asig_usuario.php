...
<div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="txt_id_usuario">
                        <?php while($fila_usuario = mysqli_fetch_array($registro_usuarios)): ?>
                            <option value="<?php echo $fila_usuario['id']; ?>" <?php if($fila_usuario['id'] == $fila_empresa['id_usuario']) echo "selected"; ?>>
                                <?php echo $fila_usuario['nombres'] . " " . $fila_usuario['apellidos']; ?>
                            </option>
                        <?php endwhile; ?>
                    </select>
                </div>
